...
public class Increase extends SimpleAction implements Execute , Serializable {
    public Increase(String mainEntityInstance, Property mainEntityProperty, Object expression,String stringExpression,EntityDefinition secondryEntity, String count, Condition condition) throws FormatException {
        ...
        if (!(super.getExpressionType().equals(Float.class.getSimpleName())) && !(super.getExpressionType().equals(Integer.class.getSimpleName())) && !(super.getExpressionType().equals(Double.class.getSimpleName()))) {
            throw new FormatException("In the increase action, on the main entity:"+super.getMainEntity()+" the expression: "+super.getExpression().toString()+" isn't numeric!");
        }
    }
    ...
    public void executeAction(EntityInstance mainEntityInstance, Environment environment,int currTick,EntityInstance seconderyEntityInstance) throws InvalidAction, ValueNotExists, FormatException {
        ...
        if (entityProperty.getValue().getClass().getSimpleName().equals(Integer.class.getSimpleName())) {
            if (super.getExpressionType().equals(Integer.class.getSimpleName())) {
                ...
                throw new FormatException("In the increase action the property: " + entityProperty.getPropertyName() + " is an integer but the expression isn't!");
            }
            ...
            if (super.getExpressionType().equals(Float.class.getSimpleName()) || super.getExpressionType().equals(Integer.class.getSimpleName())) {
             ...
             float res=propertyFloatValue + floatExpression;
                ...
                throw new FormatException("In the increase action the property: " + entityProperty.getPropertyName() + "is a float one but the expression is not numeric!");
            }
        } else {
            throw new FormatException("In the increase action the property: " + entityProperty.getPropertyName() + " isn't numeric!");
        }
    }
    ...
    public String toString() {
        return (super.toString() + "increase");
    }
}
